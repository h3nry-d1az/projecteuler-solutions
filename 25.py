...
## Solution
Recall that, given a number $n$ in base-$10$, its binary represantation is $$n = n_k n_{k-1} \cdots n_2n_1n_0 = n_0 10^0 + n_1 10^1 + \ldots + n_k 10^k,\qquad\text{where}\qquad 0\leq n_i \leq 9$$ so we want to find a mathematical function $d$ (digits of $n$) such that $d(n) = k+1$.
