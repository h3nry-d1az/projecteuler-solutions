...
## Solution
Recall that the sum of the $n$ first natural numbers can be reduced to the following expression $$1 + 2 + 3 + \ldots + n = \frac{n(n+1)}{2},$$ therefore, we can conclude that $$(1 + 2 + 3 + \ldots + n)^2 = \frac{n^2(n+1)^2}{4}. \tag{1}$$
